...
return [
    ...
    ['invoice', 'idx_invoice_expires_at', '`expires_at`'],
    ['invoice', 'idx_invoice_depleted_at', '`depleted_at`'],
    ['invoice', 'idx_invoice_location', '`Service_location`(150)'],
    ['Giftcodeconsumed', 'uniq_gift_redeem_id', '`redeem_id`', true],
    ['Giftcodeconsumed', 'idx_gift_user_code', '`id_user`(100), `code`(40)'],
    ['DiscountSell', 'idx_discount_sell_code', '`codeDiscount`(40)'],
    ['Discount', 'idx_discount_gift_code', '`code`(40)'],
